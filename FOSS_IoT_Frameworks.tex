...
\item Adaptability: \textbf{average} - There is no separations of roles in the documentation, but rather a collection of categories, which goes directly from the "Getting Started and tutorials" to "Specific technical information". There is no page adressing the global architecture.
\end{itemize}
