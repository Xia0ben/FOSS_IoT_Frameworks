...
\item Latest Release Date: \textbf{2017/07/23} - Since the first release, 54 other releases were made, the latest one dating from month before this review. We can therefore assume it is still an active project.
