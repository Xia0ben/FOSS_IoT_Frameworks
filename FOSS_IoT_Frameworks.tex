...
\item Modularity: \textbf{excellent} - As everything is API, any component can be added/changed/removed easily.
\end{itemize}
...
\item Platform scalability: \textbf{average} - It doesn't seem like any sort of inter-instance communication has been devised, nor is there any integrated load-balancing.
\end{itemize}
